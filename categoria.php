...
<head>
    ...
    <title>Página Inicial | Ladamia Cosmetics</title>
    <!-- CSS -->
...
$consulta= $conn->query("Select cd_produto,nm_produto, vl_preco, ds_imagem, qt_estoque from vw_produto where ds_categoria = '$cat'");
?>
