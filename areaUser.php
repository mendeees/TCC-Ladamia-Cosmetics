...
<head>
<meta charset="utf-8">
<title>Área do Usuário | Ladamia Cosmetics</title>
...
<body>	
    ...
    $consultaVenda= $conn->query("select * from vw_venda where cd_cliente = '$cd_usuario' group by no_ticket");
...
<h1 class="text-center" style="margin-bottom:50px"> Minhas Compras</h1>
	...
	<div class="row" style="margin-top: 15px;font-size: 15px;margin-bottom: 15px;">
		...
		<div class="col-sm-2"><b><h4> Ticket</h4> </b></div>
    </b>
...
<?php while($exibeVenda = $consultaVenda->fetch(PDO::FETCH_ASSOC)) { ?>
    <div class="row" style="margin-bottom: 10px">
		...
		<div class="col-sm-2"><a href="ticket.php?ticket=<?php echo $exibeVenda['no_ticket']; ?>" style="color:#f10680"><?php echo $exibeVenda['no_ticket']; ?></a> </div>
